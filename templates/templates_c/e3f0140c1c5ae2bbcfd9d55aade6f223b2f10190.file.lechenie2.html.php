...
<head>
	...
	<link href="stylesheets/skins/tango/skin.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript" src="javascripts/jquery.mCustomScrollbar.js"></script>
...
<?php echo $_smarty_tpl->tpl_vars['content']->value;?>
	...
	<div class="header_container">
		<div class="header_inner">
			<a href="#" class="logo" title="Intourist"></a>
		...
		<!-- menu -->
			<ul class="nav_menu">
				...
				<li><a href="#">Цены на путёвки</a></li>
		...
		<div class="customScrollBox">
			...
			<div class="container">
				<div class="content">
					...
					<a href="images/slider/img1.jpg"  rel="group2"><img src="images/slider/img1_sm.jpg" alt=""/></a>
					<a href="images/slider/img2.jpg"  rel="group2"><img src="images/slider/img2_sm.jpg" alt=""/></a>
					...
					<a href="images/slider/img3.jpg"  rel="group2"><img src="images/slider/img3_sm.jpg" alt=""/></a>
					...
					<a href="images/slider/img4.jpg"  rel="group2"><img src="images/slider/img4_sm.jpg" alt=""/></a>
					<a href="images/slider/img5.jpg"  rel="group2"><img src="images/slider/img5_sm.jpg" alt=""/></a>
					...
					<a href="images/slider/img6.jpg"  rel="group2"><img src="images/slider/img6_sm.jpg" alt=""/></a>
					...
					<a href="images/slider/img7.jpg"  rel="group2"><img src="images/slider/img7_sm.jpg" alt=""/></a>
					<a href="images/slider/img8.jpg"  rel="group2"><img src="images/slider/img8_sm.jpg" alt=""/></a>
	...
	<div class="sidebar_block">
		...
		<div class="s_block">
			...
			<ul>
				<li><a href="#">Перечень заболеваний</a></li>
		...
		<div class="s_block fading">
			<p class="title"> <a href="#">все новости</a> Новости</p>
		...
		<div class="s_block">
			...
			<a href="#"><img class="map" src="images/map.jpg" alt="" /></a>
		</div>
		...
		<div class="s_block">
			...
			<div id="mycarousel1" class="jcarousel-skin-tango">
				<ul>
					<li><a rel="group" href="uploads/excursions/img1.jpg" ><img src="uploads/excursions/img1.jpg" alt="" /></a></li>
					<li><a rel="group" href="uploads/excursions/img1.jpg" ><img src="uploads/excursions/img1.jpg" alt="" /></a></li>
					<li><a rel="group" href="uploads/excursions/img1.jpg" ><img src="uploads/excursions/img1.jpg" alt="" /></a></li>
					<li><a rel="group" href="uploads/excursions/img1.jpg" ><img src="uploads/excursions/img1.jpg" alt="" /></a></li>
					<li><a rel="group" href="uploads/excursions/img1.jpg" ><img src="uploads/excursions/img1.jpg" alt="" /></a></li>
	...
	<div class="content_block">
		<h1>Лечение</h1>
		<!-- text about us-->
		<p>В июле 2007 года санаторий «Пятигорский нарзан» принял первых отдыхающих. Они сразу по достоинству оценили предложенный высокий сервис и комфорт, новейшее лечебно-диагностическое оборудование, позволяющее приносить максимальную пользу здоровью отдыхающих.
		<img class="image_content_right" src="uploads/1.jpg" alt="" />
		

Пятигорск — многопрофильный курорт, при лечении используются лечебные минеральные воды, которых в нем более 20 видов: углекислые, углекисло-сероводородные сложного ионного состава, радоновые, хлоридно-натриевые и другие.<br /><br />Среди гидроминеральных богатств района Кавказских Минеральных Вод особое место занимает минеральное озеро Большой Тамбукан с донными отложениями грязи, обладающей лечебными свойствами.<br /><br /> Все разновидности грязи отличаются значительным содержанием железа, высокими аусорбирующими свойствами, вязкостью, что позволяет применить их для аппликационного метода грязелечения, используемого в санаториях Пятигорска.</p>
		<br />
		<p><b>Уважаемые отдыхающие!</b></p>
		<br />
		<p>Обращаем Ваше пристальное внимание на то, что назначение объема диагностических (клинические и биохимические исследования в лаборатории, ЭКГ, УЗИ и др.) видов лечения, количество и виды процедур определяются Вашим лечащим врачом или лечащим врачом санатория, исходя из диагноза, стадии и фазы заболевания, наличия сопутствующих заболеваний с учетом Методических указаний Министерства здравоохранения РФ от 22.12.1999 г. «Медицинские показания и противопоказания к санаторно-курортному лечению взрослых и подростков» и приказов МЗ и СР № 209-278 от 22-23. 11.2004 г. «Об утверждении стандартов санаторно-курортной помощи больным».</p><br />
		<p>Все вышеуказанные сведения должны быть занесены Вашим лечащим врачом в санаторно-курортную карту, которую Вы должны иметь на руках при заезде в санаторий.</p>
		<p>В случае отсутствия у Вас на руках заполненной Вашим лечащим врачом санаторно-курортной карты, в отношении Вас будет проведено обследование врачами санатория, которое осуществляется за дополнительную плату.</p>	
	...
	<div class="items">
		...
		<div class="img_border">
	 		<a href="#" ><img src="uploads/main_previews/img4.jpg" alt="" /></a>
		</div>
	...
	<div class="items">
		...
		<div class="img_border">
	 		<a href="#" ><img src="uploads/main_previews/img5.jpg" alt="" /></a>
		</div>
	...
	<div class="items">
		...
		<div class="img_border">
	 		<a href="#" ><img src="uploads/main_previews/img6.jpg" alt="" /></a>
		</div>
	...
	<div class="items">
		...
		<div class="img_border">
	 		<a href="#" ><img src="uploads/main_previews/img7.jpg" alt="" /></a>
		</div>
	...
	<div class="items">
		...
		<div class="img_border">
	 		<a href="#" ><img src="uploads/main_previews/img8.jpg" alt="" /></a>
		</div>
	...
	<div class="items">
		...
		<div class="img_border">
	 		<a href="#" ><img src="uploads/main_previews/img9.jpg" alt="" /></a>
		</div>
